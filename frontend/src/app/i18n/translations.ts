...
export const TRANSLATIONS: Record<Lang, Dictionary> = {
  en: {
    ...
    'search.sheetTitle': 'Search & filters',
    'search.sheetButton': 'Search',
    'search.sheetOpen': 'Open search & filters',
    'search.sheetClose': 'Close search & filters',
    'search.filtersActive': 'Active filters: {count}',
    ...
    'search.verifiedBadge': 'Verified',
    'search.unverifiedBadge': 'To verify',
  ...
  fr: {
    ...
    'search.sheetTitle': 'Recherche & filtres',
    'search.sheetButton': 'Rechercher',
    'search.sheetOpen': 'Ouvrir la recherche & les filtres',
    'search.sheetClose': 'Fermer la recherche & les filtres',
    'search.filtersActive': 'Filtres actifs : {count}',
    ...
    'search.source': 'Source :',
    'search.verifiedBadge': 'Vérifié',
    'search.unverifiedBadge': 'À vérifier',
  ...
  ar: {
    ...
    'search.sheetTitle': 'البحث والفلاتر',
    'search.sheetButton': 'بحث',
    'search.sheetOpen': 'فتح البحث والفلاتر',
    'search.sheetClose': 'إغلاق البحث والفلاتر',
    'search.filtersActive': 'الفلاتر النشطة: {count}',
    ...
    'search.verifiedBadge': 'موثّق',
    'search.unverifiedBadge': 'قيد التحقق',
