...
export const TRANSLATIONS: Record<Lang, Dictionary> = {
  en: {
    ...
    'search.labelBrand': 'Brand',
    'search.labelModel': 'Model',
    'search.labelBudget': 'Max budget (€)',
    'search.labelFuel': 'Fuel type',
    ...
    'search.bestPriceAt': 'Best price at {source}',
    'search.source': 'Source:',
    'search.viewListing': 'View listing',
    'search.estimateShipping': 'Estimate shipping cost',
    'search.quickBadgesLabel': 'Quick searches',
    'search.quickUnder15000': 'Under €15,000',
    'search.quickElectricHybrid': 'Electric / Hybrid',
  ...
  fr: {
    ...
    'search.labelBrand': 'Marque',
    'search.labelModel': 'Modèle',
    'search.labelBudget': 'Budget max (€)',
    'search.labelFuel': 'Motorisation',
    ...
    'search.bestPriceAt': 'Meilleur prix chez {source}',
    'search.source': 'Source :',
    'search.viewListing': "Voir l'annonce",
    'search.estimateShipping': 'Estimer le coût de transport',
    'search.quickBadgesLabel': 'Recherches rapides',
    'search.quickUnder15000': 'Moins de 15 000 €',
  ...
  ar: {
    ...
    'search.labelBrand': 'الماركة',
    'search.labelModel': 'الطراز',
    'search.labelBudget': 'الميزانية القصوى (€)',
    'search.labelFuel': 'نوع الوقود',
    ...
    'search.bestPriceAt': 'أفضل سعر لدى {source}',
    'search.source': 'المصدر:',
    'search.viewListing': 'عرض الإعلان',
    'search.estimateShipping': 'تقدير تكلفة الشحن',
    'search.quickBadgesLabel': 'بحث سريع',
    'search.quickUnder15000': 'أقل من 15.000 €',
